...
os.environ["GROQ_API_TOKEN"]=env("GROQ_API_TOKEN")

EMAIL_BACKEND = env('EMAIL_BACKEND')
EMAIL_HOST = env('EMAIL_HOST')
EMAIL_PORT = int(env('EMAIL_PORT'))  # convert to int
EMAIL_USE_TLS = env('EMAIL_USE_TLS') == 'True'  # convert string to bool
    ...
    'default': {
        ...
        'PORT':  env('DATABASE_PORT'),          # Database port
         'OPTIONS': {
            'charset': 'utf8mb4',
            'ssl': {
                'ca': '/code/ca.pem',  # Path in Docker image (see below)
            }
        }
    }
}
